...
const DEFAULT_BAN_WORDS = readJsonList(path.join(__dirname, '..', 'data', 'ban_words.json'), [
  ...
  'drug', 'drugs', 'druggie', 'addict', 'addicted', 'selfharm', 'self-harm', 'suicide', 'самоубийство', 'суицид',
  'срезать', 'резать', 'порез', 'нож', 'knife', 'razor', 'blade', 'cutting', 'смерть', 'умирать', 'хочуумереть',
