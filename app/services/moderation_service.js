...
const DEFAULT_BAN_WORDS = readJsonList(path.join(__dirname, '..', 'data', 'ban_words.json'), [
  'вскрыться', 'меф', 'кокаин', 'мет', 'долбить соль', 'герыч', 'героин', 'мдма', 'марихуана',
  'нюхать соль', 'курить соль', 'нюхать траву', 'курить траву', 'выпилиться', 'марихуаны',
  'снюхать', 'мефедрон', 'ебать детей', 'повешусь', 'повеситься', 'конопля', 'лсд',
  'дезоморфин', 'крэк', 'ебал мать', 'трахал мать', 'мать ебал', 'мать трахал',
  'я ебал твою мать', 'я трахал твою мать', 'кокс', 'крек', 'метадон', 'водный', 'водник',
  'анаша', 'хапка', 'ляпка', 'гашик', 'гашиш', 'гаш', 'спайс', 'спайсуха',
  'кетамин', 'джанк', 'фетанил', 'псилоцибин', 'опиаты', 'опиат', 'вскроюсь', 'морфий', 'вскрюсь', 'нарко',
  'вздёрнуться', 'вздернусь', 'вздёрнулась', 'самоубийство', 'маму ебал', 'вскрываться',
  'сын шлюхи', 'дочь шалавы', 'петля', 'резать вены', 'порезать вены', 'объебыш',
  'обьёбыш', 'объебанный', 'наркотики'
]);
    ...
    return {
      ...
      banwordSettings: {
        punishmentMode: ['off', 'warn', 'mute', 'ban'].includes(String(chat.banwordSettings?.punishmentMode || '').toLowerCase())
          ...
          : 'off',
        deleteMessages: chat.banwordSettings?.deleteMessages !== false,
      },
      warnSettings: {
