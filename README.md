...
- Команды наказаний принимают числовой ID, `@юз` или ответ на сообщение.
...
Мини-приложение находится в папке `miniapp`.
...
В Telegram можно открыть мини-приложение через команду `/miniapp` или `/миниприложение`.
Доступ ограничен администраторами группы с правами управления настройками.